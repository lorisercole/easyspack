...
"""
[OBSOLETE] Upstream database creation method using spood.
---

Configure Spack user paths before running this script:
    export SPACK_USER_CONFIG_PATH=/home/lercole/spood/spack
    export SPACK_USER_CACHE_PATH=/home/lercole/spood/spack/cache
or
    export SPACK_USER_CONFIG_PATH=/home/lercole/eessi/spack
    export SPACK_USER_CACHE_PATH=/home/lercole/eessi/spack/cache

SPOOD_DEBUG=1 ./upstreamdb_quick_start.py
"""
...
import spack
from spood.legacy import SpecLoader, add_packages_to_config
